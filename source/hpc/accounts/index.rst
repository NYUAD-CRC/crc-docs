...
Kindly follow below steps needed for the HPC collaboration:
    ...
    1. For the :download:`HPC Collaboration Template.docx <../docs/HPC_Collaboration_Template.docx>`
    
   	 a. The collaborator needs to fill it and sign it.
    
   	 b. The NYUAD PI's signature is also required.
...
Account Lifecycle
-----------------
When you request or renew an HPC account, it is valid for one year. After this period, the account enters a series of states if not renewed, each with specific access permissions and data retention policies.

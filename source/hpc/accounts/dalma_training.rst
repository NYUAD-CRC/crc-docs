...
We request all the users to pass the following quiz before submitting jobs. Make sure to log in your NYU Google Apps Account (e.g., NYU Google Mail) first! Otherwise, your access to the Quiz will be denied.
